...
# Function to calculate the percentage of monthly precipitation out of the annual total
calculate_pct_annual_rainyr_PPT_1960.2021 <- function(precip_data_1960.2021) {
  # Group data by rain_year and calculate the annual total precipitation
  annual_totals_1960.2021 <- precip_data_1960.2021 |>
    group_by(rain_year) |>
    summarise(Annual_rainyr_PPT = sum(Precipitation, na.rm = TRUE))
  
  # Join the annual totals back to the original data
  precip_data_1960.2021 <- precip_data_1960.2021 |>
    left_join(annual_totals_1960.2021, by = "rain_year")
  
  # Calculate the percentage of each month's precipitation out of the annual total
  precip_data_1960.2021 <- precip_data_1960.2021 |>
    mutate(pct_rainyr_PPT = (Precipitation / Annual_rainyr_PPT) * 100)
  
  return(precip_data_1960.2021)
}
